...
export class NotificationsGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  addFriendNotification(
    @MessageBody() addFriendNotificationDto : AddFriendNotificationDto
      ...
      const notification = notificationsService.createAddedByFriendNotification({addFriendNotificationDto});
  ...
  removeFriendNotification(
    @MessageBody() removeFriendNotificationDto : RemoveFriendNotificationDto
      ...
      const notification = notificationsService.createRemovedByFriendNotification({removeFriendNotificationDto});
