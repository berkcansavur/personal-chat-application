...
import { ChatGroupNotCreatedException, ChatGroupNotFoundException, ChatGroupNotRemovedException, ChatGroupsNotFoundException, ChatGroupsUsersNotFoundException, CouldNotAddedUserToChatGroupException, CouldNotRemovedUserFromChatGroupException, CouldNotUpdatedChatGroupNameException } from './exceptions';
...
export class ChatGroupsService implements IChatGroupService {
    ...
    async createChatGroup({
        ...
        if(!newChatGroup){
            throw new ChatGroupNotCreatedException({createChatGroupDTO});
        }
    ...
    async deleteChatGroup({
        ...
        if(!chatGroup){
            throw new ChatGroupNotRemovedException({ chatGroupId});
        }
