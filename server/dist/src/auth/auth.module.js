...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [utils_module_1.UtilsModule, users_module_1.UsersModule, passport_1.PassportModule.register({ session: true }),
            jwt_1.JwtModule.register({
                secret: utils_service_1.jwtConstants.secret,
